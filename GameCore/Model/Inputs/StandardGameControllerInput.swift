...
public extension StandardGameControllerInput
{
    ...
    func input(for gameType: GameType) -> Input?
    {
        ...
        guard
            ...
            let fileURL = deltaCore.resourceBundle.url(forResource: deltaCore.mappingName, withExtension: "dgmapping")
        else { fatalError("Cannot find Standard.dgmapping for game type \(gameType)") }
